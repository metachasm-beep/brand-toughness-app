        ...
        <header className="h-[90px] px-10 flex items-center justify-between sticky top-0 z-[100] bg-[#0B0F14]/60 backdrop-blur-3xl border-b border-white/5 shrink-0">
            ...
            <div className="flex items-center flex-1 max-w-lg">
                <div className="relative w-full group">
                    <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#B05CFF] transition-all" size={18} />
                    <input
                        type="text"
                        placeholder="SEARCH BRAND INTEL"
                        className="w-full bg-white/[0.03] border border-white/5 rounded-2xl py-3.5 pl-14 pr-5 outline-none focus:bg-white/[0.06] focus:border-[#B05CFF]/30 transition-all text-[11px] font-black tracking-[0.3em] uppercase placeholder:text-white/10 text-white"
                    />
            ...
            {/* Right controls */}
                ...
                <div className="flex items-center gap-4 border-r border-white/5 pr-10">
                    <button className="relative p-3 bg-white/[0.03] border border-white/5 rounded-xl hover:bg-white/5 transition-all text-white/40 hover:text-[#B05CFF] group">
                        <Bell size={18} />
                    ...
                    <div className="hidden lg:flex flex-col items-end">
                        <span className="surgical-label !text-[9px] !text-[#B05CFF]">Strategy Link</span>
