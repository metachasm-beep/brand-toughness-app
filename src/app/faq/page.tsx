...
const faqs = [
    {
        q: "What is BRAND OS?",
        a: "BRAND OS is a diagnostic intelligence unit designed to analyze the technical and strategic integrity of a digital brand. It scans over 150 metrics in 60 seconds to provide a comprehensive 'Toughness Score'."
    },
    {
    ...
    {
        q: "Is my data secure?",
        a: "Yes. BRAND OS uses end-to-end encryption for all diagnostic data. We only scan publicly accessible infrastructure and do not require administrative access to your servers."
    },
    {
